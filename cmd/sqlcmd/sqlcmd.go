...
type SQLCmdArguments struct {
	...
	Server string `short:"S" help:"[[tcp:]||[np:]]server[\\instance_name][,port]Specifies the instance of SQL Server to which to connect. It sets the sqlcmd scripting variable SQLCMDSERVER."`
