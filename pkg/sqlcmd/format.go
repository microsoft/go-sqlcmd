...
// NewSQLCmdDefaultFormatterWithOptions returns a Formatter with additional options
func NewSQLCmdDefaultFormatterWithOptions(removeTrailingSpaces bool, ccb ControlCharacterBehavior, rawErrors bool) Formatter {
	return &sqlCmdFormatterType{
		removeTrailingSpaces: removeTrailingSpaces,
		format:               "horizontal",
		colorizer:            color.New(false),
